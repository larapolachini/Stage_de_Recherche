...
uint32_t const base_tumble_time = 31 * kiloticks_to_µs;
double const offset = -5;
double const scaling = 64;
double const d_optim = 48;
uint32_t const lower_tumble_time = 0 * 31 * kiloticks_to_µs;
uint32_t const upper_tumble_time = 2 * 31 * kiloticks_to_µs;
